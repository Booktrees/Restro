<div>
	<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
		<div class="navbar-header">
                ...
                <a class="navbar-brand" href="/admin">Foodmin - A Restro on Your Hand</a>
            </div>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <!--  <li>
                                    <a href="/admin/view-menu">View menu</a>
                                </li> -->
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                          <li>
                            <a href="/admin/category"><i class="fa fa-dashboard fa-fw"></i> Category</a>
                        </li>
                    </ul>
                </div>
            </div>
